		...
		<nav class="navbar navbar-default">
		  <div class="container-fluid">
		    ...
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand" href="${ctx}/index.action"><font color="black"><strong>首页</strong></font></a>
		    </div>
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
		      ...
		      <form action="${ctx}/blog/query.action" class="navbar-form navbar-right" role="search" method="post" onsubmit="return checkData()">
		        <div class="form-group" >
		          <input type="text" id="query" name="queryKey" value="${query }" class="form-control" placeholder="请输入要查询的关键字...">
		        </div>
