...
<div id="p" class="easyui-panel" title="修改个人信息" style="padding: 10px">
	<form id="form1" action="${ctx}/admin/modifyInfo.action" method="post" enctype="multipart/form-data">
	 	<table cellspacing="20px">
	   		<tr>
	   			<td width="80px">用户名：</td>
	   			<td>
	   				<input type="hidden" id="id" name="id"/>
	   				<input type="text" id="userName" name="user_name" style="width: 200px;" readonly="readonly"/>
	   			</td>
	   		</tr>
	   		<tr>
	   			<td>昵称：</td>
	   			<td><input type="text" id="nickName" name="nick_name"  style="width: 200px;"/></td>
	   		</tr>
	   		<tr>
	   			<td>个性签名：</td>
 ...
 <script type="text/javascript">
    ...
    ue.addListener("ready",function(){
        //通过ajax请求数据
        UE.ajax.request("${ctx}/admin/findBlogger.action",
            {
                method:"post",
                async : false,  
                data:{"id":"1"},
